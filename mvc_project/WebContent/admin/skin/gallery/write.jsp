		...
		<div class="board_write_area">
			...
			<div class="board_write_chk">
				<ul class="clear list01">
					...
					<c:if test="${optionVo.op_is_notice == 1}">
			...
			<div class="board_write">
				<ul class="clear list01">
					<li><span class="tit">참여율</span><span class="con"><input type="text" name="bo_1" value="${bVo.bo_1 }" size="5" /> %</span></li>
					<li><span class="tit">기간</span><span class="con"><input type="text" name="bo_2" value="${bVo.bo_2 }" size="80" class="datepicker"/> ~ <input type="text" name="bo_3" value="${bVo.bo_3 }" size="80" class="datepicker"/></span></li>
					<li><span class="tit">개발언어</span><span class="con"><input type="text" name="bo_4" value="${bVo.bo_4 }" size="300" /> </span></li>
					<li><span class="tit">링크</span><span class="con"><input type="text" name="bo_5" value="${bVo.bo_5 }" size="300" /> </span></li>
				</ul>
			</div>
			<!-- board_file -->
